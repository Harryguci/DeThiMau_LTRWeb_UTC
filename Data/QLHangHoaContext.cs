...
namespace BaiThiMau.Data
{
    public partial class QLHangHoaContext : DbContext
    {
        ...
        public static string ConnectionString =
            "Data Source=(Local);Initial Catalog=QLHangHoa;Integrated Security=True;Persist Security Info=True;User ID=sa;Password=123456;Encrypt=True;Trust Server Certificate=True";
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                optionsBuilder.UseSqlServer("Server=(Local);Database=QLHangHoa; Persist Security Info=True;User ID=sa;Password=123456;Trusted_Connection=True;");
            }
        }
